...
def test_ellip_norm1():
    def trial(r1, r2):
        res = 1/(4*pi*1.602*10**-19*(r2 - r1))
        return res
    sum1 =0
    print('hi') 
    for n in range(10):
        for p in range(1, 2*n+1):
            sum1 += 4*pi*ellip_harm(10,15,n,p,80)*ellip_harm_2(10,15,n,p,70)/((2*n + 1)*ellip_normal(10,15,n,p))
    assert_almost_equal(sum1, trial(80,70))
...
#    known_funcs = {(1, 1): G11, (1, 2): G12, (1, 3): G13, (2, 1): G21, (2, 2): G22, (2, 3): G23, (2, 4): G24, (2,5): G25, (3, 1): G31, (3, 2): G32, (3, 3): G33, (3, 4): G34, (3, 5): G35, (3, 6): G36, (3, 7): G37 }
#    point_ref =[]
#    def ellip_normal_known(h2, k2, n, p):
#        for i in range(h2.size):
#            func = known_funcs[(int(n[i]), int(p[i]))]
#            point_ref.append(func(h2[i], k2[i]))
#        return point_ref
...
#               points.append((h2[i], k2[i], int(n), int(p)))
#    points = np.array(points
#    assert_func_equal(ellip_normal, ellip_normal_known, points)
